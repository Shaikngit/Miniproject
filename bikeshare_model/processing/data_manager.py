...
# 1. Extracts the day and month from the dteday variable
def pre_pipeline_preparation(data_frame):
...
#removing this pipeline as we are not doing here, we changed the name of function in the above 
