...
class ModelConfig(BaseModel):
    ...
    handle_outliers_temp_var: str
    handle_outliers_atemp_var: str
    handle_outliers_hum_var: str
    handle_outliers_windspeed_var: str
    yr_var: str
    mnth_var: str
    season_var: str
    weathersit_var: str
...
def create_and_validate_config(parsed_config: YAML = None) -> Config:
    ...
    _config = Config(
        ...
        model_config_data =ModelConfig(**parsed_config.data),
    )
